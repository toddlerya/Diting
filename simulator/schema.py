...
class ServiceResource(BaseResource):
    ...
    retry_policy: RetryPolicyConfig | None = Field(default=None, description="服务重试策略")
...
class EntityConfig(BaseModel):
    ...
    name: str | None = None
    seed: int = 42
    resources: ServiceResource | InfraResource | dict[str, Any] = Field(default_factory=dict)
